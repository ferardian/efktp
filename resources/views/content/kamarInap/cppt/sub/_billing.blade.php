<div class="card shadow-none border-0 bg-transparent">
    <div class="card-body p-0">
        <div class="alert alert-info border-start border-4 border-info mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check form-switch me-3 mb-0">
                    <input class="form-check-input" type="checkbox" id="printShowObatDetailRanap" checked>
            ...
            <div class="card-body p-2">
                <div class="row g-2 small text-dark">
                    <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-4 fw-bold">Bangsal/Kamar</div>
                            <div class="col-8" id="billing_kamar">: -</div>
                        </div>
                        <div class="row">
                            <div class="col-4 fw-bold">Tgl. Perawatan</div>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered mb-0" id="tabelBillingRanap">
...
@push('script')
<script>
    function loadBillingRanap(no_rawat) {
        const tbody = $('#tabelBillingRanap tbody');
        ...
        $.get(`{{ url('/billing/ranap') }}`, { no_rawat: no_rawat })
            .done((response) => {
                ...
                $('#billing_kamar').text(': ' + response.kamar);
                $('#billing_tgl').text(': ' + response.tgl_perawatan);
