...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 50, 'name' => 'Penjualan Obat Bebas', 'url' => 'farmasi/penjualan', 'icon' => null, 'parent_id' => 4, 'order_num' => 9, 'target' => '_self', 'position' => 'navbar', 'roles' => ['admin', 'apoteker', 'petugas', 'owner']],
